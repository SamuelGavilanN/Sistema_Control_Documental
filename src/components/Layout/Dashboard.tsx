...
const transacciones = [
  ...
  { id: 'sd-informe-bultos', label: 'SD02 · Informe Bultos Desp.', desc: 'Informe de bultos despachados', color: '#14b8a6' },
  { id: 'sd-informe-unidades', label: 'SD03 · Informe Un Desp', desc: 'Informe de unidades por centro', color: '#0ea5e9' },
  { id: 'sd-analisis-bultos', label: 'SD04 · Análisis Bultos Desp', desc: 'Comparativo de bultos programados vs despachados', color: '#8b5cf6' },
