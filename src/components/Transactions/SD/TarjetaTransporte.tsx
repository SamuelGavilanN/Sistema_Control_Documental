        ...
        <div className="tarjeta-header-left">
          ...
          <span className="tarjeta-estado">
            <span
              style={{
                background:
                  estado === "borrador" ? "#fef3c7" :
                  estado === "en_proceso" ? "#dbeafe" :
                  estado === "finalizado" ? "#dcfce7" : "#fef2f2",
                color:
                  estado === "borrador" ? "#b45309" :
                  estado === "en_proceso" ? "#1d4ed8" :
                  estado === "finalizado" ? "#15803d" : "#dc2626",
                padding: "2px 8px",
                borderRadius: "12px",
                fontSize: "11px",
                fontWeight: 600,
            ...
            >
              {estado === "borrador" ? "Borrador" :
               ...
               estado === "finalizado" ? "Finalizado" : "Anulado"}
            </span>
          </span>
        </div>
          ...
          <div className="tarjeta-seccion">
            <div className="tarjeta-dato">
              ...
              <span className="tarjeta-value">
                {fechaProgramacion
                  ? new Date(fechaProgramacion + "T00:00:00").toLocaleDateString("es-CL")
                  : "-"}
              </span>
            </div>
          </div>
