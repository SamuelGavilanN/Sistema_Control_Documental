// src/components/Transactions/SD/SellosAdicionales.tsx

import React, { useState } from "react";
import "./SellosAdicionales.css";
...
const SellosAdicionales: React.FC<SellosAdicionalesProps> = ({
  selloLateral,
  selloAdicional,
  onSelloLateralChange,
  onSelloAdicionalChange,
  disabled = false,
}) => {
    ...
    <div className="sellos-container">
      ...
      {expandido && (
        <div className="sellos-body">
          <div className="sellos-field">
            <label>Sello Lateral</label>
            <input
              type="text"
              value={selloLateral}
