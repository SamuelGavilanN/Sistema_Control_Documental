    ...
    <div className="app-container">
      ...
      <div className="main-panel">
        ...
        <div className="workspace">
          ...
          {!['dashboard', 'ed', 'ed-history', 'ed-tickets', 'ed-lotes', 'sd', 'sd-informe-bultos', 'sd-informe-unidades', 'sd-analisis-bultos', 'sd-estado-carga', 'sd-pedidos-especiales', 'sd-comparativa-cd01', 'sd-consultor', 'ut', 'ut-revision', 'bd-usuarios', 'bd-locales'].includes(activeTab) && (
